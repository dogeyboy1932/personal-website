...
const homeFocusAreas = [
  {
    ...
    description: "Building scalable full-stack applications with modern frameworks and clean architecture."
  },
  {
    title: "AI Engineering",
    description: "Designing and implementing intelligent systems with machine learning and AI technologies."
  },
  {
    title: "Data Management",
    description: "Building robust data pipelines and storage solutions for large-scale applications."
  }
];
const homeNavigationCards = [
  {
    title: "Career Portfolio",
    description: "See projects, internships, and skills that shaped my journey.",
    cta: "See portfolio",
    href: "/portfolio"
  },
  ...
  {
    title: "More About Me",
    description: "Clubs, hobbies, and interests that keep me busy.",
    cta: "Browse",
    href: "/more"
  }
];
...
const site = {
  ...
  description: "Meet Akhil Gogineni, a Computer Science graduate student at UIUC. Explore his portfolio showcasing expertise in full-stack development, cloud engineering, and AI.",
  author: "Venkat Akhil Gogineni"
};
export {
  links as a,
  homeFocusAreas as b,
  homeNavigationCards as c,
  sections as d,
  home as e,
  homeHero as h,
  lastUpdated as l,
