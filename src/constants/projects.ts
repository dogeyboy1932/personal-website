...
export const projectsData: ProjectData = {
  projects: [
    ...
    },
    {
      ...
      description: 'A Solana-based dApp that uses Multi-Party Computation and Zero-Knowledge proofs for secure, private P2P interactions and game state. (Literally the mafia card game but on the Solana blockchain',
      githubLink: 'https://github.com/evcoats/on-chain-mafia-game'
    },
    {
      title: 'GymBro',
      duration: 'June 2024 - Aug 2024',
      description: 'A multi-platform fitness app that tracks workouts, creates visualizations, and includes real-time chat features.',
      githubLink: 'https://github.com/sdimov2/gymapp'
    },
    {
      title: 'Upland Chess',
      duration: 'Nov 2023 - Jan 2024',
      description: 'A chess app built on the Upland Metaverse where users can play and wager crypto.',
