...
export const connectMethods = [
	{
		title: 'Coffee chat',
		description: 'Let’s swap stories about design, data, and the next big idea. Remote friendly or on campus.',
		cta: 'Schedule a chat',
		href: 'mailto:akhilg4@illinois.edu'
	},
	{
		title: 'Speaking & panels',
		description: 'Workshops on rapid prototyping, product strategy, or student leadership.',
		cta: 'Request a session',
		href: 'mailto:akhilg4@illinois.edu'
	},
	{
		title: 'Collaboration',
		description: 'Building something ambitious? I love joining forces on mission-driven work.',
		cta: 'Pitch your idea',
		href: '/projects'
	}
] as const;
